...
| Command                                                                              | Description                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `mm launch --platform ios --device <udid> --app-bundle <path> [--metro-port <port>]` | Launches a MetaMask Mobile session in the iOS simulator. `--device` is the simulator UDID, `--app-bundle` is the path to the built `.app`. `--metro-port` (default 8081) sets the session-scoped Metro inspector proxy port — see Per-Worktree Setup below.                                   |
