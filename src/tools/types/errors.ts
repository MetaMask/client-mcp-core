export const ErrorCodes = {
  ...
  MM_HERMES_CDP_BLOCKED: 'MM_HERMES_CDP_BLOCKED',
  MM_HERMES_CDP_FAILED: 'MM_HERMES_CDP_FAILED',
  MM_HERMES_CONNECTION_FAILED: 'MM_HERMES_CONNECTION_FAILED',
  MM_HERMES_TARGET_NOT_FOUND: 'MM_HERMES_TARGET_NOT_FOUND',
  MM_HERMES_TARGET_NOT_VERIFIED: 'MM_HERMES_TARGET_NOT_VERIFIED',
  MM_HERMES_UNSAFE_TARGET: 'MM_HERMES_UNSAFE_TARGET',
  MM_HERMES_DEVICE_PIN_MISMATCH: 'MM_HERMES_DEVICE_PIN_MISMATCH',

  MM_IOS_ELEMENT_NOT_FOUND: 'MM_IOS_ELEMENT_NOT_FOUND',
  MM_IOS_SNAPSHOT_FAILED: 'MM_IOS_SNAPSHOT_FAILED',
  MM_IOS_EMPTY_SNAPSHOT: 'MM_IOS_EMPTY_SNAPSHOT',
  MM_IOS_AX_PERMISSION_REQUIRED: 'MM_IOS_AX_PERMISSION_REQUIRED',
  MM_IOS_AX_BINARY_MISSING: 'MM_IOS_AX_BINARY_MISSING',
  MM_IOS_AX_SNAPSHOT_FAILED: 'MM_IOS_AX_SNAPSHOT_FAILED',
  MM_IOS_AX_DEVICE_NOT_FOUND: 'MM_IOS_AX_DEVICE_NOT_FOUND',
  MM_IOS_RUNNER_RECOVERING: 'MM_IOS_RUNNER_RECOVERING',
  MM_IOS_RUNNER_NOT_READY: 'MM_IOS_RUNNER_NOT_READY',
  MM_IOS_APP_IDENTITY_MISMATCH: 'MM_IOS_APP_IDENTITY_MISMATCH',

  MM_UNKNOWN_TOOL: 'MM_UNKNOWN_TOOL',
  MM_INTERNAL_ERROR: 'MM_INTERNAL_ERROR',

  MM_TOOL_NOT_SUPPORTED_ON_PLATFORM: 'MM_TOOL_NOT_SUPPORTED_ON_PLATFORM',
} as const;
